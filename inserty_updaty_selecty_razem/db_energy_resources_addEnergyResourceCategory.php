...
if ($result)
{
  //echo "<br><h4><center><span style='color: white; background-color: black'>Kategoria zasobu enegetycznego zapisana.</span></center></h4>";
  echo "<br><p style='color: green;font-size:25px;'>Kategoria zasobu enegetycznego zapisana.</p>";
}
else
{
  if($_POST)
