...
<h4 class="text-white text-center mt-3"> Wielkości fizyczne </h4>
...
$atr = read_table("units.quantities");
	...
	echo "<th style='color: white'> Bazowa Jednostka ID: </th>";
	echo "</tr>";
...
<form method="get" action="db_units_updateQuantityAndBaseUnit.php">
	<label class="text-white">ID Nazwy Fiz: </label><input type="number"  name="QuantityID" class="form-control" />
	<br>
...
<br>
<br>
<h4 class="text-white text-center mt-3"> Wielkości podstawowe </h4>
<br>
